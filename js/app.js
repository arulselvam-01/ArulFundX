...
function renderRankingTab() {
  ...
  if (!filteredFunds.length) {
    tbody.innerHTML = `<tr><td colspan="6" style="text-align:center;color:var(--text-muted);padding:32px">No funds in this category found. Try another category.</td></tr>`;
    return;
  }
